...
hero:
  ...
  actions:
    - theme: brand
      text: Get Started
      link: /1.x/guide/getting-started
    - theme: alt
      text: Query Builder
      link: /1.x/guide/query-builder
features:
  - icon:
      src: /prisma-icon.svg
      alt: Prisma Icon
  ...
  - icon:
    ...
    title: Documentation
    details: End-to-end guides for setup, querying, relationships, migrations, and CLI usage.
  - icon:
      src: /typescript.svg
  ...
  - icon:
    ...
    title: Community
    details: Join our growing community of developers and contribute to the project.
  - icon:
