...
Configure `modelsPath` when your models live outside Arkormˣ’s configured model directory:
...
The `modelsPath` option is optional. When omitted, the plugin will use the model path defined in your Arkormˣ config:
