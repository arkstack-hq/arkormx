...
export class DbUser extends Model<'user'> {
  ...
  public tags() {
    return this.morphToMany(DbTag, 'taggable')
  }
...
export async function seedPostgresFixtures() {
  ...
  await prisma.$executeRawUnsafe(
    'TRUNCATE TABLE "taggables", "tags", "comments", "images", "role_users", "roles", "posts", "profiles", "articles", "users" RESTART IDENTITY CASCADE',
  )
