...
export type RawSelectInput = string | string[] | Record<string, boolean | string | undefined>
...
type FallbackIfUnknownOrNever<TValue, TFallback> = [TValue] extends [never]
  ? TFallback
...
export type QuerySchemaCreateData<TSchema extends ModelQuerySchemaLike> = Parameters<
  TSchema['create']
>[0] extends { data: infer TData }
  ? TData
  : Record<string, unknown>

export type QuerySchemaUpdateArgs<TSchema extends ModelQuerySchemaLike> = Parameters<
  TSchema['update']
>[0]
...
export type QuerySchemaRow<TSchema extends ModelQuerySchemaLike> = Exclude<
  Awaited<ReturnType<TSchema['findFirst']>>,
  null
>

export type QuerySchemaRows<TSchema extends ModelQuerySchemaLike> = Awaited<
  ReturnType<TSchema['findMany']>
>
...
export type DelegateFindManyArgs<TSchema extends ModelQuerySchemaLike> =
  QuerySchemaFindManyArgs<TSchema>
