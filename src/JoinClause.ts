...
export class JoinClause {
  ...
  private addOn(
    ...
    const [resolvedOperator, resolvedSecond] =
      second === undefined ? ['=', operator] : [operator, second]
  ...
  private addWhere(
    ...
    const [resolvedOperator, resolvedValue] =
      value === undefined ? ['=', operator as DatabaseValue] : [operator, value]
